    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/IlyaK1V/foodgram" className={styles.textLink} target="_blank" rel="noopener noreferrer">Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://www.linkedin.com/in/ilya-kravchenko/" className={styles.textLink} target="_blank" rel="noopener noreferrer">Илья Кравченко</a>
            </p>
          </div>
        </aside>
      </div>
